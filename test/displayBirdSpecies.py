...
# Initialize the variable to store the last modified timestamp of the photo
last_modified_timestamp = None

while True:
    # Check if the photo has been updated
    modified_timestamp = os.path.getmtime(photo_path)
    if modified_timestamp != last_modified_timestamp:
